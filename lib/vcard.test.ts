...
describe("vCard", () => {
  ...
  it("omits unavailable optional fields", () => {
    const employee: Employee = { id: "1", active: true, first_name: "Ada", last_name: "Lovelace", job_title: "Director", department: null, email: null, phone: null, website: null, address: null, linkedin_url: null, bio: null, photo_url: null, slug: "ada-lovelace", created_at: "", updated_at: "" };
